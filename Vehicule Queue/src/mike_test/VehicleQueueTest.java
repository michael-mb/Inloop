...
import mike_class.Bicycle;
import mike_class.Bus;
import mike_class.Car;
import mike_class.Time;
import mike_class.Vehicle;
import mike_class.VehicleGenerator;
import mike_class.VehicleQueue;
...
public class VehicleQueueTest {
    ...
    public static void setUpTestData() {
        ...
        queueSizeValues = new int[] { 1, 2, 4, 5, 7, 8, 10, 11, 12, 14, 10, 7, 3, 0, 0, 0, 0, 0, 0, 0, 2, 3, 4, 6, 7,
                ...
                13, 14 };
        testDataList.add(new VehicleQueueTestData(0.7, 0.2, 10, queueSizeValues)); // HIER BIN ICH !!!
    }
